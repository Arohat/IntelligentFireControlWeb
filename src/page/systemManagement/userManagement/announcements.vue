<template>
	<div>
		<el-breadcrumb separator-class="el-icon-arrow-right">
			...
			<el-breadcrumb-item>接口用户管理</el-breadcrumb-item>
		</el-breadcrumb>
		...
		<div class="container-table">
			<el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
				...
				<el-table-column label="接口用户名" prop="name" width="100">
				</el-table-column>
				<el-table-column label="负责人" prop="chargePerson" width="200">
				</el-table-column>
				<el-table-column label="联系电话" prop="phone" width="200">
				</el-table-column>
				<el-table-column label="接口专用ID" prop="apiuId" width="200">
				</el-table-column>
				<el-table-column label="接口秘钥" prop="apiSecret" width="200">
				</el-table-column>
				<el-table-column label="限制访问IP" prop="restrictedIp" width="200">
				</el-table-column>
